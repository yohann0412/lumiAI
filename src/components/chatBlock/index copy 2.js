...
const ChatBlock = () => {
  return (
    ...
    >
      ...
      <div className="flex w-full max-w-md flex-col gap-4 border border-cblack-50 rounded-lg bg-cblack-100 p-4 shadow-md">
        <div className="max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-cblack-50 scrollbar-track-cblack-100">
          {mock.map((item, index) => (
            <div
              key={index}
              className="flex flex-col bg-cblack-50 p-4 mb-3 rounded-lg shadow hover:shadow-lg transition-shadow"
            >
